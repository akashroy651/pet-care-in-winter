...
const Register = () => {
  ...
  const handleRegister = (event) => {
    ...
    if (!strongPasswordPattern.test(password)) {
      setError('Password must be at least 6 character long, and include at least uppercase, number and one special character');
      return;
    }
    // ❗ FIX NOTE = regex valid হলে proceed করবে ना হলে error
    ...
    // ❗ FIX NOTE = checkbox must be validated before user created
